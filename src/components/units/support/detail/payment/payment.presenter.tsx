...
import SupportComplete from './complete';
import { Bottom, Line, Top, Wrapper } from './payment.styles';
import { ISupportPaymentUIProps } from './payment.types';

export default function SupportPaymentUI(props: ISupportPaymentUIProps) {
        ...
        <Wrapper>
          ...
          <Bottom>
            ...
            <div className="bottomRight">
              ...
              <form className="payment" onSubmit={e => props.onClickPayment(e)}>
                <div className="contents">
                  ...
                  <div className="rowGrid">
                    <p>총 기부 금액</p>
                    <p>{getPrice(Number(props.selectAmount))}원</p>
                  </div>
                </div>
                <button>기부하기</button>
              </form>
