...
import PrivateRouteLayout02 from 'components/commons/privateRouter/index2';
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route element={<PrivateRouteLayout />}>
            ...
            <Route path="/market/:id/payment" element={<MarketPaymentPage />} />
          ...
          <Route element={<PrivateRouteLayout02 />}>
